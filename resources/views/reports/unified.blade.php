...
<body>
        ...
        <table>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <img src="{{ public_path('images/logo.png') }}" alt="Eco Hydrotech Logo" style="max-height: 50px; margin-bottom: 8px;">
                    <div class="company-name">ECO HYDROTECH SOLUTIONS</div>
    ...
    @if(count($locations_data) > 0)
        @foreach($locations_data as $loc)
            <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-top: 3px solid {{ $loc['status'] === 'Completed' ? '#10b981' : '#f59e0b' }}; padding: 10px; margin-bottom: 12px; margin-top: 8px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td style="font-weight: bold; font-size: 10pt; color: #0f172a; width: 60%;">
                            {{ $loc['name'] }}
                        </td>
                        <td style="text-align: right; width: 40%;">
                            <span style="font-size: 8pt; font-weight: bold; padding: 3px 6px; border-radius: 4px; color: #fff; background: {{ $loc['status'] === 'Completed' ? '#10b981' : '#f59e0b' }};">
                                {{ strtoupper($loc['status']) }}
                            </span>
                        </td>
                    </tr>
                </table>
                <table class="data-table" style="margin-top: 8px; margin-bottom: 0;">
                    <tr>
        ...
        @endforeach
    @else
        <div style="padding: 10px; color: #64748b; font-size: 8.5pt;">No survey areas defined for this project.</div>
    @endif
