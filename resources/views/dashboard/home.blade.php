...
<head>
    ...
    <title>Quotation Workspace</title>
            ...
            <div class="project-card">
                <div class="project-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="project" name="project" value="{{ $prefillProject?->name ?? '' }}">
                    </div>
                    ...
                    <div class="form-group date-period-group">
                        <div class="date-period-wrapper">
                            ...
                            <div class="period-item">
                                ...
                                <input type="text" id="period" name="period" value="{{ $prefillProject?->period ?? '' }}" placeholder="Auto-calculated (if dates present)">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="client" name="client" value="{{ $prefillProject?->client?->company_name ?? '' }}">
                    </div>

                    <div class="form-group">
                        <label for="client_address">CLIENT ADDRESS</label>
                        <textarea id="client_address" name="client_address" rows="3">{{ $prefillProject?->client?->client_address ?? '' }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pic" name="pic" value="{{ $prefillProject?->pic_name ?? '' }}">
                    </div>

                    <div class="form-group">
                        <label for="pic_no">NO. OF PIC</label>
                        <input type="text" id="pic_no" name="pic_no" value="{{ $prefillProject?->pic_no ?? '' }}">
                    </div>
                </div>
            </div>

            @if($estimation)
                <div class="project-card mt-3 border-start border-4 border-primary">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <div class="text-uppercase text-muted small fw-bold">Survey estimation snapshot</div>
                            <div class="small text-muted">Calculated from the saved survey areas for this project.</div>
                        </div>
                        <div class="d-flex gap-4 text-end">
                            <div>
                                <div class="text-muted small">Distance</div>
                                <strong>{{ number_format($estimation['distance_nm'], 4) }} NM</strong>
                            </div>
                            <div>
                                <div class="text-muted small">Survey hours</div>
                                <strong>{{ number_format($estimation['survey_hours'], 2) }}</strong>
                            </div>
                            <div>
                                <div class="text-muted small">Total duration</div>
                                <strong>{{ number_format($estimation['total_days'], 2) }} days</strong>
                            </div>
                        </div>
                    </div>
                </div>
